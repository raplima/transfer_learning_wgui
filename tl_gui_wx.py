...
class MainFrame (wx.Frame):
    def __init__(self, parent):
        ...
        self.m_dirPicker4 = wx.DirPickerCtrl(self.m_panel1, wx.ID_ANY, wx.EmptyString, u"Select a folder",
                                             wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE)
        self.m_dirPicker4.SetToolTip(u"Select a folder containing subfolders (classes) and each one of the subfolders contains images. ")

        gbSizer.Add(self.m_dirPicker4, wx.GBPosition(0, 1), wx.GBSpan(1, 1), wx.ALL, 5)
        ...
        self.m_comboBox2 = wx.ComboBox( self.m_panel1, wx.ID_ANY, u"10", wx.DefaultPosition, wx.DefaultSize, m_comboBox2Choices, 0 )
        gbSizer.Add( self.m_comboBox2, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

        self.m_staticText_testper = wx.StaticText( self.m_panel1, wx.ID_ANY, u"Select test percentage:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_comboBox21 = wx.ComboBox( self.m_panel1, wx.ID_ANY, u"10", wx.DefaultPosition, wx.DefaultSize, m_comboBox21Choices, 0 )
        ...
        self.m_staticText_split = wx.StaticText( self.m_panel1, wx.ID_ANY, u"Split data:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_button_runTL1.SetToolTip( u"Press this button after selecting the options above. \nThe program will then use split the data into training, validation, and test sets. " )

        gbSizer.Add( self.m_button_runTL1, wx.GBPosition( 3, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.EXPAND, 5 )
        ...
        self.m_panel2 = wx.Panel( self.m_notebook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_RAISED|wx.TAB_TRAVERSAL )
        ...
        self.m_staticText_trFolder = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Select training data folder:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_dirPicker_trFolder = wx.DirPickerCtrl( self.m_panel2, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
        self.m_dirPicker_trFolder.SetToolTip( u"Select a folder with subfolders containing images from the same class to be used in training. " )

        gbSizer1.Add( self.m_dirPicker_trFolder, wx.GBPosition(0, 1), wx.GBSpan(1, 1), wx.ALL, 5)

        self.m_staticText_valFolder = wx.StaticText(self.m_panel2, wx.ID_ANY, u"Select validation data folder:", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_dirPicker_valFolder = wx.DirPickerCtrl( self.m_panel2, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
        self.m_dirPicker_valFolder.SetToolTip( u"Select a folder with subfolders containing images from the same class to be used in validation (validation helps in the analysis of hyperparameters and overfitting). " )

        gbSizer1.Add( self.m_dirPicker_valFolder, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_staticText_cnnModel = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Choose one CNN model", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        m_choice_ModelChoices = [ u"Xception", u"VGG16", u"VGG19", u"ResNet50", u"NASNetLarge", u"DenseNet121", u"MobileNetV2", u"MobileNet", u"InceptionResNetV2", u"InceptionV3" ]
        self.m_choice_Model = wx.Choice( self.m_panel2, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice_ModelChoices, 0 )
        self.m_choice_Model.SetSelection( 0 )
        self.m_choice_Model.SetToolTip( u"Choose one of the available CNN models previously trained in the ImageNet data. The model selected here is the base of the model to be generated when running transfer learning. " )

        gbSizer1.Add( self.m_choice_Model, wx.GBPosition( 2, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND, 5 )

        self.m_staticText_bName = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Enter bottlenecks' name:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_textCtrl_bName.SetToolTip( u"A tag to be part of the bottlenecks name (for training and validation). This tag is then reused below when runing transfer learning. " )

        gbSizer1.Add( self.m_textCtrl_bName, wx.GBPosition( 3, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND, 5 )

        self.m_staticText_bneck = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Create bottlenecks:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_button_runBot.SetToolTip( u"Press this button after selecting the options above. \nThe program will then save bottlenecks based on the options selected. " )
        ...
        self.m_staticText_mName = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Create bottlenecks", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_staticText_nEpochs = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Select number of epochs:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_comboBox_nEpochs = wx.ComboBox( self.m_panel2, wx.ID_ANY, u"10", wx.DefaultPosition, wx.DefaultSize, m_comboBox_nEpochsChoices, 0 )
        ...
        self.m_staticText_wOpt = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Choose one optimizer:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_choice_Opt = wx.Choice( self.m_panel2, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_choice_OptChoices, 0 )
        self.m_choice_Opt.SetSelection( 1 )
        self.m_choice_Opt.SetToolTip( u"Choose one of the available CNN models previously trained in the ImageNet data. The model selected here is the base of the model to be generated when running transfer learning. " )

        gbSizer1.Add( self.m_choice_Opt, wx.GBPosition( 8, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND, 5 )

        self.m_staticText_wOpt1 = wx.StaticText( self.m_panel2, wx.ID_ANY, u"Run transfer learning:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_button_runTL.SetToolTip( u"Press this button after selecting the options above. \nThe program will then use the bottlenecks indicated to perform transfer learning. " )
        ...
        self.m_staticText_label = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Label data with new model", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL )
        self.m_staticText_label.Wrap( -1 )

        gbSizer2.Add( self.m_staticText_label, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 2 ), wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL, 5 )

        self.m_staticText_mSelect = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Select model:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText_mSelect.Wrap( -1 )

        gbSizer2.Add( self.m_staticText_mSelect, wx.GBPosition( 1, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_filePicker_model = wx.FilePickerCtrl( self.m_panel3, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
        ...
        self.m_staticText_iSelect = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Select image to be classified:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText_iSelect.Wrap( -1 )

        gbSizer2.Add( self.m_staticText_iSelect, wx.GBPosition( 3, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_filePicker_image = wx.FilePickerCtrl( self.m_panel3, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
        self.m_filePicker_image.SetToolTip( u"Select one image that will be classfied with the retrained model selected above. The classification happens automatically after the image is selected." )

        gbSizer2.Add( self.m_filePicker_image, wx.GBPosition( 3, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_staticline21 = wx.StaticLine( self.m_panel3, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
        gbSizer2.Add( self.m_staticline21, wx.GBPosition( 4, 0 ), wx.GBSpan( 1, 2 ), wx.EXPAND |wx.ALL, 5 )

        self.m_staticText_iSelectF = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Select folder to be classified:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText_iSelectF.Wrap( -1 )

        gbSizer2.Add( self.m_staticText_iSelectF, wx.GBPosition( 5, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_dirPicker_fTest = wx.DirPickerCtrl( self.m_panel3, wx.ID_ANY, wx.EmptyString, u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
        self.m_dirPicker_fTest.SetToolTip( u"Select a folder containing sublfolders with images to be classified with the retrained model. " )

        gbSizer2.Add( self.m_dirPicker_fTest, wx.GBPosition( 5, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_staticText_blabel = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Classify the selected folder:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_button_runBLabel.SetToolTip( u"Press this button after selecting the model and folder to be classified above. \nThe program will then use the model indicated to classify the images in the subfolders. " )
...
class pop_up_fig ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        gbSizer3.Add( self.m_panel, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 2 ), wx.ALL|wx.EXPAND, 5 )

        self.m_button_previous = wx.Button( self, wx.ID_ANY, u"Previous", wx.DefaultPosition, wx.DefaultSize, 0 )
        gbSizer3.Add( self.m_button_previous, wx.GBPosition( 1, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )

        self.m_button_next = wx.Button( self, wx.ID_ANY, u"Next", wx.DefaultPosition, wx.DefaultSize, 0 )
        gbSizer3.Add( self.m_button_next, wx.GBPosition( 1, 1 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
